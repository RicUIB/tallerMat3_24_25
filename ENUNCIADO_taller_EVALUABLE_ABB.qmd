...
Se entraga en grupos que deben de estar constituidos en la actividad de grupos. 
...
Leeremos los siguientes  datos de la zona de mallorca con el código siguiente: 
...
**neighbourhoods.csv**
 ...
 Son deos columnas y la primera es una agrupación de municipios (están NA) y la 
...
Responder las siguientes preguntas  como formato Rmarkdown o quarto y entregad 
