...
```{r}
write_csv(listings_total, paste0("../clean_data/mallorca/","listings_all.csv.gz"))
write_csv(listings_common0, paste0("../clean_data/mallorca/","listing_common0.csv.gz"))
save(listings_total, file=paste0("../clean_data/mallorca/","listings_all.RData"))
save(listings_common0, file=paste0("../clean_data/mallorca/","listing_common0.RData"))
```
